...
def load_train(path_label, path_mask, path_data, img_w, img_h, img_d):
    ...
    for files in tqdm(train_label):
        ...
        fl = path_data + '/' + files.decode("utf-8")  + '.png'
        ...
        img_mask = get_im(fl, img_w, img_h, 1)
...
def main():
    ...
    output_path = args.output
    print("Create Dataset in Gray 256...")
    ...
    path_label = "C:/Users/EHO085/Desktop/data_skin/segmentation/train_seg_aug.csv"
    path_data = "C:/Users/EHO085/Desktop/data_skin/segmentation/im_dataset"
    path_mask = "C:/Users/EHO085/Desktop/data_skin/segmentation/mk_dataset"
